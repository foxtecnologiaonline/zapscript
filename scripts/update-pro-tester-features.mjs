...
const PRO_FEATURES = ['200 min/mês','2 números WhatsApp','Transcrição automática','Resumo com IA','Histórico de transcrições','Filtros por data e contato','Upload de áudio no site','Busca por transcrição','Modo Privado de transcrição','Exportação PDF · DOCX · CSV · XLS','Múltiplos idiomas (filtro)','Tags e categorização'];
