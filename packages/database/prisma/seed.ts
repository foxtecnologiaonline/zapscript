...
async function main() {
  ...
  // FREE_AUDIO_QUOTA parametrizável por env (default 300 — revisão de tiers ZapScript 2.0). PRO = teto oculto 500.
  const FREE_AUDIO_QUOTA = parseInt(process.env.FREE_AUDIO_QUOTA || '300', 10);
