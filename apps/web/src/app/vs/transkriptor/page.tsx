...
const schema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sim. O ZapScript tem plano Core com até 200 áudios de conversão por mês, sem cartão de crédito, com preço em real e suporte total ao português do Brasil.',
      },
    },
  ],
};
