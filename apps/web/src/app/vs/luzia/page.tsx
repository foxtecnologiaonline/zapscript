...
const schema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'O ZapScript tem plano Core com até 200 áudios por mês sem custo. O plano Profissional custa R$49/mês (ou R$295/ano) e inclui áudios ilimitados, atendimento automático por IA, resumo com IA e Modo Privado.',
      },
    },
  ],
};
...
const ROWS = [
  ...
  { feature: 'Plano gratuito',         zap: '✅ 200 áudios/mês',      luzia: '⚠️ Limites variam por funcionalidade' },
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'O plano Core do ZapScript inclui até 200 áudios de conversão por mês sem custo e sem cartão. O Profissional custa R$49/mês (ou R$295/ano) e inclui áudios ilimitados, atendimento automático por IA, resumo com IA, Modo Privado e histórico completo.',
  },
];
