...
const schema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'O ZapScript tem plano Free com 15 áudios por mês sem custo. O plano Pro custa R$37/mês (R$18,50 no primeiro mês) e inclui áudios ilimitados, 2 números, resumo com IA e Modo Privado.',
      },
    },
  ],
};
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'O plano Free do ZapScript inclui 15 áudios de conversão por mês sem custo e sem cartão. O Pro custa R$37/mês (R$18,50 no 1º mês) e inclui áudios ilimitados, 2 números, resumo com IA, Modo Privado e histórico completo.',
  },
];
