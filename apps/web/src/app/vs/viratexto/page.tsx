...
const schema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'O ZapScript tem plano Core com até 200 áudios por mês sem custo algum. O plano Profissional custa R$49/mês (ou R$295/ano) e inclui áudios ilimitados, atendimento automático por IA e funcionalidades que o ViraTexto não oferece, como resumo com IA, Modo Privado e exportação em PDF.',
      },
    },
    {
      '@type': 'Question',
...
const ROWS = [
  ...
  { feature: 'Plano gratuito',         zap: '✅ 200 áudios/mês',      vira: '⚠️ Limitado' },
