...
const schema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'O ZapScript tem plano Free com 20 minutos por mês sem custo algum. O plano Pro custa R$39,90/mês (ou R$19,90 no primeiro mês em junho de 2026) e inclui 200 minutos, 2 números e funcionalidades que o ViraTexto não oferece, como resumo com IA, Modo Privado e exportação em PDF.',
      },
    },
    {
      '@type': 'Question',
...
const ROWS = [
  ...
  { feature: 'Plano gratuito',         zap: '✅ 20 min/mês',          vira: '⚠️ Limitado' },
