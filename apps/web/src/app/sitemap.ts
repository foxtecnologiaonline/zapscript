...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/transcrever-audio-gratis`, lastModified: now, priority: 0.9,  changeFrequency: 'monthly' },
    ...
    { url: `${base}/campanhas`,    lastModified: now, priority: 1.0,  changeFrequency: 'monthly' },
    { url: `${base}/campanhas/imobiliarias`, lastModified: now, priority: 0.95, changeFrequency: 'monthly' },
    ...
    { url: `${base}/vs/whatsapp-business`, lastModified: now, priority: 0.8, changeFrequency: 'monthly' },
