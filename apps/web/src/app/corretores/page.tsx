...
const variant: Variant = {
  ...
  faqs: [
    ...
    { q: 'Quanto custa para começar?', a: 'Grátis. O plano Free inclui 20 minutos de conversão por mês, sem cartão de crédito. Para volume maior, o plano Pro (R$39,90/mês) oferece 200 minutos e 2 números conectados.' },
  ],
};
