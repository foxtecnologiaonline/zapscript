...
const variant: Variant = {
  ...
  faqs: [
    ...
    { q: 'Tem custo para testar?', a: 'Não. O plano Free é gratuito e inclui 20 minutos de conversão por mês, sem cartão. Para volume maior de relatos, o plano Pro (R$39,90/mês) oferece 200 minutos e 2 números.' },
  ],
};
