...
const PLANS = [
  {
    ...
    excl: ['Busca full-text', 'Exportação CSV', 'Tags & Tradução automática', 'Webhook & Modo privado'],
  ...
  },
  {
    ...
    feats: ['150 min/mês', '2 números WhatsApp', 'Transcrição automática', 'Ponto chave IA', '🔍 Busca full-text', '📤 Exportação CSV'],
    excl: ['Tags & Tradução automática', 'Webhook personalizado', 'Modo privado'],
