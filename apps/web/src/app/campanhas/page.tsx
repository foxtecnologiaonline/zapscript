...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Nada — é gratuito para todos os usuários da plataforma ZapScript. Só as tarifas de mensagem cobradas diretamente pela Meta, conforme categoria do template e política vigente, ficam de fora.',
      },
    },
  ],
};
