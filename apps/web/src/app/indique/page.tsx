...
const FAQS = [
  ...
  { q: 'Ainda não tenho conta, posso indicar?', a: 'Você precisa de uma conta ZapScript (mesmo no plano Core, grátis) para gerar seu link pessoal de indicação. Crie sua conta grátis e o link aparece automaticamente no seu painel.' },
