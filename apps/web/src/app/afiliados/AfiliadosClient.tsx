...
/* ─────────────────────────────────────────────────────────
   ...
   'use client' vive aqui (não em page.tsx) porque metadata.* (SEO) só pode
   ser exportado de um Server Component — page.tsx virou um wrapper fino
   que exporta metadata e renderiza este componente, mesmo padrão já usado
   em LandingPageClient.tsx pras páginas de nicho.
   ───────────────────────────────────────────────────────── */
