...
const TABLE_ROWS: { feature: string; vals: CmpVal[] }[] = [
  ...
  { feature: '📋 Histórico de transcrições',        vals: [true, true, true] },
  { feature: '📅 Filtros por data e contato',       vals: [true, true, true] },
  { feature: '🖥️ Upload de áudio no site',          vals: [false, true, true] },
